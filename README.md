...
Все лоты Ривер Парк Бизнес публикуются как коммерческие помещения свободного
назначения (`freeAppointmentObjectSale`) и содержат `FlatRoomsCount=7` для
совместимости с принимающей системой.
...
API-ключи. Для Ривер Парк Бизнес CIAN ID не требуется, поскольку весь фид
публикуется как коммерческая недвижимость.
