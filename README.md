...
В фиде Ривер Парк Бизнес размерные классы S/M/L публикуются как коммерческие
помещения свободного назначения (`freeAppointmentObjectSale`). Только лоты с
явным числом комнат публикуются как квартиры в новостройке.
